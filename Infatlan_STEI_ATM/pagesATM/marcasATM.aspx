<%@ Page Title="" Language="C#" MasterPageFile="~/mainATM.Master" AutoEventWireup="true" CodeBehind="marcasATM.aspx.cs" Inherits="Infatlan_STEI_ATM.pagesATM.marcasATM" %>
            ...
            <ContentTemplate>
                <div class="row col-12">
                    ...
                    <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                        <ContentTemplate>
                            <asp:Button runat="server" ID="btnnewmarcasATM" OnClick="btnnewmarcasATM_Click" CssClass="btn btn-info mr-2" Text="Nuevo" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                <br />
                                                ...
                                                <asp:GridView ID="GVBusqueda" runat="server"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Selección" ItemStyle-HorizontalAlign="center">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnmarca" runat="server" CssClass="btn btn-info mr-2" Text="Modificar" CommandArgument='<%# Eval("idMarca") %>' CommandName="Codigo"></asp:LinkButton>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="col-md-8 align-self-center" style="margin-left: auto; margin-right: auto">
                                <asp:Label runat="server" Style="color: red;" Visible="false" BorderStyle="none" ID="lbmarca1" CssClass="col form-control"><strong></strong></asp:Label>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                ...
                <div class="modal-content">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="col-md-8 align-self-center" style="margin-left: auto; margin-right: auto">
                                <asp:Label runat="server" Style="color: red;" Visible="false" BorderStyle="none" ID="lbmarca2" CssClass="col form-control"><strong></strong></asp:Label>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
