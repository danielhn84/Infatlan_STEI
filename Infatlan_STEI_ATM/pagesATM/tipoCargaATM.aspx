<%@ Page Title="" Language="C#" MasterPageFile="~/mainATM.Master" AutoEventWireup="true" CodeBehind="tipoCargaATM.aspx.cs" Inherits="Infatlan_STEI_ATM.pagesATM.tipoCargaATM" %>
    ...
    <div class="row col-12" style="margin-left:10px; margin-left:10px;">
            ...
            <ContentTemplate>
               ...
               <label class="col-3 col-form-label">Tipos de carga de ATM creados</label> 
                    <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                       <ContentTemplate>
                          <asp:Button runat="server" ID="btnguardartipocargaATM" OnClick="btnguardartipocargaATM_Click"   CssClass="btn btn-info mr-2" Text="Nuevo" />
                       </ContentTemplate>
                   </asp:UpdatePanel>
               </div>
                <br />
                                                ...
                                                <asp:GridView ID="GVBusqueda" runat="server"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Selección" ItemStyle-HorizontalAlign="center" >
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btntipoCarga" runat="server" CssClass="btn btn-info" Text="Modificar" CommandArgument='<%# Eval("idTipoCargaATM") %>' CommandName="Codigo"></asp:LinkButton>
        ...
        <div class="modal bs-example-modal-lg" id="modalTipoCargaATM" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
            ...
            <ContentTemplate>
                ...
                <div class="col-md-8 align-self-center" style="margin-left:auto; margin-right:auto">
                    <asp:label runat="server" style="color:red;" Visible="false"  borderstyle="none" ID="lbtipoCarga1" CssClass="col form-control" ><strong></strong></asp:label>
                    </div>
                </ContentTemplate>
                         </asp:UpdatePanel>
        ...
        <div class="modal bs-example-modal-lg" id="modalTipoCargaATM2" tabindex="-1" data-backdrop="static" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
            ...
            <ContentTemplate>                   
                ...
                <div class="col-md-8 align-self-center" style="margin-left:auto; margin-right:auto">
                    <asp:label runat="server" style="color:red;" Visible="false"  borderstyle="none" ID="lbtipocarga2" CssClass="col form-control" ><strong></strong></asp:label>
                    </div>
                </ContentTemplate>
                         </asp:UpdatePanel>
