<%@ Page Title="" Language="C#" MasterPageFile="~/mainATM.Master" AutoEventWireup="true" CodeBehind="tecladoATM.aspx.cs" Inherits="Infatlan_STEI_ATM.pagesATM.tecladoATM" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">Ingresar nuevo teclado de ATM</h4>
        </div>
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Inicio</a></li>
                    <li class="breadcrumb-item active">Ingresar nuevo teclado ATM</li>
                </ol>
    ...
    <div class="card">
        ...
        <div class="row col-12" style="margin-left: 10px; margin-left: 10px;">
            <h3 class="text-themecolor" style="color: #808080;"><i class="fa fa-save"></i>Ingresar nuevo teclado ATM</h3>
        </div>
        <br />
        <hr />
        <br />
            ...
            <ContentTemplate>
                <div class="row col-12">
                    ...
                    <asp:UpdatePanel runat="server" ID="UpdatePanel2">
                        <ContentTemplate>
                            <asp:Button runat="server" ID="btnnewtecladoATM" OnClick="btnnewtecladoATM_Click" CssClass="btn btn-info mr-2" Text="Nuevo" />
                        </ContentTemplate>
                    </asp:UpdatePanel>
                </div>
                <br />
                                                ...
                                                <asp:GridView ID="GVBusqueda" runat="server"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Selección" ItemStyle-HorizontalAlign="center">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="btnteclado" runat="server" CssClass="btn btn-info mr-2" Text="Modificar" CommandArgument='<%# Eval("idTecladoATM") %>' CommandName="Codigo"></asp:LinkButton>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="col-md-8 align-self-center" style="margin-left: auto; margin-right: auto">
                                <asp:Label runat="server" Style="color: red;" Visible="false" BorderStyle="none" ID="lbteclado1" CssClass="col form-control"><strong></strong></asp:Label>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                        <ContentTemplate>
                            <div class="modal-footer col-12">
                                ...
                                <div class="row col-3">
                                    <asp:Button runat="server" ID="btnModalCerrarTecladoATM" OnClick="btnModalCerrarTecladoATM_Click" CssClass="btn btn-danger mr-2" Text="Cancelar" />
                                </div>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                ...
                <div class="modal-content">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="col-md-8 align-self-center" style="margin-left: auto; margin-right: auto">
                                <asp:Label runat="server" Style="color: red;" Visible="false" BorderStyle="none" ID="lbteclado2" CssClass="col form-control"><strong></strong></asp:Label>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                    <asp:UpdatePanel ID="UpdatePanel5" runat="server">
                        <ContentTemplate>
                            <div class="modal-footer col-12">
                                ...
                                <div class="row col-3">
                                    <asp:Button runat="server" ID="btnModalCerrarNueviTecladoATM" OnClick="btnModalCerrarNueviTecladoATM_Click" CssClass="btn btn-danger mr-2" Text="Cancelar" />
                                </div>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
