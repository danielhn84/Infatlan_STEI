<%@ Page Title="" Language="C#" MasterPageFile="~/mainATM.Master" AutoEventWireup="true" CodeBehind="updateATM.aspx.cs" Inherits="Infatlan_STEI_ATM.pagesATM.updateATM" %>
                ...
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card" id="21">
                            <div class="card-body">
                                <h4 class="card-title">ATM creados</h4>
                                                ...
                                                <asp:GridView ID="GVBusqueda" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Select"  ItemStyle-HorizontalAlign="center">
                                                            <ItemTemplate>--%>
                                                                <asp:LinkButton runat="server" ID="btnmodificarATM" Text="Modificar" CssClass="btn btn-info mr-2" CommandArgument='<%# Eval("Codigo") %>' CommandName="Modificar"></asp:LinkButton>
