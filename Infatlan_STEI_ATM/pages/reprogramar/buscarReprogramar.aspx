<%@ Page Title="" Language="C#" MasterPageFile="~/mainATM.Master" AutoEventWireup="true" CodeBehind="buscarReprogramar.aspx.cs" Inherits="Infatlan_STEI_ATM.pages.reprogramar.buscarReprogramar" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="col-md-10 align-self-center" style="margin-left: auto; margin-right: auto">
                                <br />
                                <h5 runat="server" visible="false" id="H5Alerta" class="text-danger"><i class="fa fa-exclamation-triangle"></i>Ingrese nueva fecha de mantenimiento.</h5>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
