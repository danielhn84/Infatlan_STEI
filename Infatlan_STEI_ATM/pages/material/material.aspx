...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
            ...
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">
                        <asp:Literal Text="" ID="LitRuta" runat="server" /></a></li>
    ...
    <div class="card">
        <div class="card-body">
            ...
            <h6 class="card-subtitle">Solicitar materiales necesarios para mantenimiento de ATM</h6>
                            ...
                            <div class="col-md-12 align-self-center" runat="server" id="DIVTablaMateriales" style="margin-left: auto; margin-right: auto">
                                <table class="tablesaw table-bordered table-hover table no-wrap" data-tablesaw-mode="swipe"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:DropDownList ID="DDLStock" runat="server" AutoPostBack="true" OnTextChanged="DDLStock_TextChanged" CssClass="form-control"></asp:DropDownList></td>
                                            <td>
                                                <asp:TextBox ID="txtmarca" runat="server" Enabled="false" CssClass="form-control"></asp:TextBox></td>
                                            <td>
                                                <asp:TextBox ID="txtcantidad" runat="server" CssClass="form-control" TextMode="Number" AutoPostBack="true" OnTextChanged="txtcantidad_TextChanged"></asp:TextBox></td>
                                            <td>
                                                <asp:LinkButton runat="server" ID="btnVerifATM" OnClick="btnVerifATM_Click" Text="" CssClass="btn btn-success  ti-check-box mr-2"></asp:LinkButton></td>
                                        </tr>
