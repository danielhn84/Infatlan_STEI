    ...
    public partial class buscarAprobar : System.Web.UI.Page
    {
        ...
        protected void TxBuscarMantenimientoATM_TextChanged(object sender, EventArgs e)
        {
            try
            {
                ...
                DataTable vDatos = (DataTable)Session["ATM_MATERIALES_APROBAR_MANTENIMIENTO"];
                ...
                else
                {
                    ...
                    GVBusqueda.DataBind();
                    Session["ATM_MATERIALES_APROBAR_MANTENIMIENTO"] = vDatosFiltrados;
                    UpdateGridView.Update();
                }
        ...
        {
            DataTable vDataaaa = (DataTable)Session["ATM_MATERIALES_APROBAR_MANTENIMIENTO"];
