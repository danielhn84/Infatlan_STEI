    ...
    public partial class teclado : System.Web.UI.Page
    {
        ...
        protected void btnModalEnviarTecladoATM_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    string vQuery = "STEISP_ATMAdminComponentesATM 15, '" + Session["codtecladoATM"] + "','" + txtModalNewTecladoATM.Text + "', '" + Session["usuATM"].ToString() + "'";
        ...
        protected void btnModalNueviTecladoATM_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    string vQuery = "STEISP_ATMAdminComponentesATM 14, '" + Session["codtecladoATM"] + "','" + txtNewTecladoATM.Text + "','" + Session["usuATM"].ToString() + "'";
                    Int32 vInfo = vConexion.ejecutarSQL(vQuery);
                    if (vInfo == 1)
                    {
                        H5Alerta2.Visible = false;
