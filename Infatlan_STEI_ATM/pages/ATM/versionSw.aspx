<%@ Page Title="" Language="C#" MasterPageFile="~/mainATM.Master" AutoEventWireup="true" CodeBehind="versionSw.aspx.cs" Inherits="Infatlan_STEI_ATM.pages.ATM.versionSw" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="col-md-10 align-self-center" style="margin-left: auto; margin-right: auto">
                                <br />
                                <h5 runat="server" visible="false" id="H5Alerta1" class="text-danger"><i class="fa fa-exclamation-triangle"></i>Ingrese nueva versión de software.</h5>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
                ...
                <div class="modal-content">
                    ...
                    <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                        <ContentTemplate>
                            ...
                            <div class="col-md-10 align-self-center" style="margin-left: auto; margin-right: auto">
                                <br />
                                <h5 runat="server" visible="false" id="H5Alerta2" class="text-danger"><i class="fa fa-exclamation-triangle"></i>Ingrese nueva versión de software.</h5>
                            </div>
                        </ContentTemplate>
                    </asp:UpdatePanel>
