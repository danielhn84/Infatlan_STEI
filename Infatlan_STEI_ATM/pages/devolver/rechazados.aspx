<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="rechazados.aspx.cs" Inherits="Infatlan_STEI_ATM.pages.devolver.rechazados" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    <script type="text/javascript">
        function openEmpleadosModal() { $('#EmpleadoModal').modal('show'); }
        function openPasswordModal() { $('#PasswordModal').modal('show'); }
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Modificar Lista de Verificación</h4>
            <h6 class="card-subtitle">Seleccione lista de verificación que modificará</h6>
