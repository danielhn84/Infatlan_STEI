...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
   ...
   <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-themecolor col-12">Listas de verificación</h3>
            <h6 class="text-themecolor col-12">Seleccione lista de verificación que modificará</h6>
        </div>
                ...
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card" id="21">
                            <div class="card-body">
                                <h4 class="card-title">Modificar lista verificación</h4>                                
                            </div>
                        </div>
                    </div>
                </div>
