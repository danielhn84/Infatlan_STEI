                    ...
                    <table class="tablesaw table-bordered table-hover table no-wrap" data-tablesaw-mode="swipe"
                        ...
                        <thead>
                            <tr>
                                ...
                                <th scope="col" style="background-color:#5D6D7E;color:#D5DBDB;" data-tablesaw-sortable-col data-tablesaw-priority="1" class="border" ><abbr title="Haga click a la imagen para verla más grande">Mostrar imagen</abbr></span></th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><asp:FileUpload ID="FUDiscoDuro" Enabled="false" runat="server" onchange="img1(this);" /></td> 
                                <td><img runat="server" id="imgDiscoDuro" height="150" width="150" src="" style="border-width: 0px;" /></td>                                
                            </tr>
                            <tr>
                                <td class="title"><a class="link" href="javascript:void(0)">ATM desarmado parte superior (limpiar)</a></td>                               
                                <td><asp:FileUpload ID="FUATMDesarmadoPS" Enabled="false" runat="server" onchange="img2(this);" /></td>
                                <td><img runat="server" id="imgATMDesarmadoPS" height="150" width="150" src="" style="border-width: 0px;" /></td>
                            </tr>
                            <tr>
                                <td class="title"><a class="link" href="javascript:void(0)">ATM desarmado parte inferior (limpiar)</a></td>                               
                                <td><asp:FileUpload ID="FUATMDesarmadoPI" Enabled="false" runat="server" onchange="img3(this);" /></td>
                                <td><img runat="server" id="imgATMDesarmadoPI" height="150" width="150" src="" style="border-width: 0px;" /></td>
                            </tr>
                            <tr>
                                <td class="title"><a class="link" href="javascript:void(0)">Dispositivo modo diagnostico de vendor en linea</a></td>                                
                                <td><asp:FileUpload ID="FUDispositivoVendor" Enabled="false" runat="server" onchange="img4(this);" /></td>
                                <td><img runat="server" id="imgDispositivoVendor" height="150" width="150" src="" style="border-width: 0px;" /></td>
                            </tr>
                            <tr>
                                <td class="title"><a class="link" href="javascript:void(0)">Tipo de procesador con el comando "SYSTEMINFO"</a></td>                              
                                <td><asp:FileUpload ID="FUSYSTEMINFO" Enabled="false" runat="server" onchange="img5(this);" /></td>
                                <td><img runat="server" id="imgSYSTEMINFO" height="150" width="150" src="" style="border-width: 0px;" /></td>
                            </tr>
                            <tr>
                                <td class="title"><a class="link" href="javascript:void(0)">Lectora con el antiskimming desarmado y limpio</a></td>
                                <td><asp:FileUpload ID="FUAntiskimmin" Enabled="false" runat="server" onchange="img6(this);" /></td>
                                <td><img runat="server" id="imgAntiskimmin" height="150" width="150" src="" style="border-width: 0px;" /></td>
                            </tr>
                            <tr>
                                <td class="title"><a class="link" href="javascript:void(0)">Monitor con el filtro</a></td>                              
                                <td> <asp:FileUpload ID="FUMonitorFiltro" Enabled="false" runat="server" onchange="img7(this);" /></td>
                                <td><img runat="server" id="imgMonitorFiltro" height="150" width="150" src="" style="border-width: 0px;" /></td>
                            </tr>
                            <tr>
                                <td class="title"><a class="link" href="javascript:void(0)">PadleWheel(rueda de paletas)</a></td>                               
                                <td><asp:FileUpload ID="FUPadlewheel" Enabled="false" runat="server" onchange="img8(this);" /></td>
                                <td><img runat="server" id="imgPadlewheel" height="150" width="150" src="" style="border-width: 0px;" /></td>
                            </tr>
                            <tr>
                                <td class="title"><a class="link" href="javascript:void(0)">Dispositivos desarmado</a></td>                              
                                <td><asp:FileUpload ID="FUDispDesarmado" Enabled="false" runat="server" onchange="img9(this);" /></td>
                                <td><img runat="server" id="imgDispDesarmado" height="150" width="150" src="" style="border-width: 0px;" /></td>
                            </tr>
                            <tr>
                                <td class="title"><a class="link" href="javascript:void(0)">Teclado</a></td>                              
                                <td><asp:FileUpload ID="FUTeclado" Enabled="false" runat="server" onchange="img10(this);" /></td>
                                <td><img runat="server" id="imgTeclado" height="150" width="150" src="" style="border-width: 0px;" /></td>
                            </tr>
                            <tr>
                                <td class="title"><a class="link" href="javascript:void(0)">¿Cuenta con Climatización adecuada?</a></td>                            
                                <td><asp:FileUpload ID="FUClimatizacion" runat="server" Enabled="false" onchange="img11(this);" /></td>
                                <td><img runat="server" id="imgClimatizacion" height="150" width="150" src="" style="border-width: 0px;" /></td>
                            </tr>
                            <tr>
                                <td class="title"><a class="link" href="javascript:void(0)">¿Cuenta con protección de energía<br /> eléctrica?</a></td>                             
                                <td><asp:FileUpload ID="FUEnergia" runat="server" Enabled="false" onchange="img12(this);" /></td>
                                <td><img runat="server" id="imgEnergia" height="150" width="150" src="" style="border-width: 0px;" /></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
        ...
        <asp:UpdatePanel ID="UPEnviarVerif" runat="server">
            <ContentTemplate>
                <div class="col-md-12 align-self-center" style="margin-left: auto; margin-right: auto">
                    <div class=" row col-12">
                <div class="col-6">
                    <asp:Button runat="server" ID="btnEnviarVerif" OnClick="btnEnviarVerif_Click" CssClass="btn btn-rounded btn-block btn-outline-success" Text="Aprobar" />
                </div>
                 <div class="col-6">
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                    <ContentTemplate>
                        <div class="modal-footer col-12">
                            <div class="row col-3">
                                <asp:Button runat="server" ID="btnModalVerif" UseSubmitBehavior="false" OnClick="btnModalVerif_Click"  CssClass="btn btn-success mr-3" Text="Aprobar" />
                            </div>
                            <div class="row col-3">
            ...
            <div class="modal-content">
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <div class="row col-12">
                            <asp:Label runat="server" ID="lbValidarModal2" Visible="false" BorderStyle="None" Style="color: red;" class="col form-control col-12"><strong></strong>  </asp:Label>
                        </div>
                    </ContentTemplate>
                </asp:UpdatePanel>
