<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="cancelarMantenimiento.aspx.cs" Inherits="Infatlan_STEI_ATM.pages.mantenimiento.cancelarMantenimiento" %>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                                            <ContentTemplate>
                                                                <asp:TextBox ID="txtBuscarCancelado" OnTextChanged="txtBuscarCancelado_TextChanged" runat="server" placeholder="ingrese ATM - Presione afuera para proceder" class="form-control" AutoPostBack="true"></asp:TextBox>
                                                            </ContentTemplate>
                                                        </asp:UpdatePanel>
                                                    </div>
                                                </div>
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <div class="row col-12">
                            <asp:Label runat="server" BorderStyle="None" class="col form-control col-3"><strong>ATM: </strong></asp:Label>                          
                                <asp:Label runat="server" ID="LbATM" CssClass="col-form-label col-9"/>
                        </div>   
                        <div class="row col-12">
            ...
            <div class="modal-content">
                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        <div class="row col-12">
                            <asp:Label runat="server" BorderStyle="None" class="col form-control col-3"><strong>ATM: </strong></asp:Label>                          
                                <asp:Label runat="server" ID="LbATMCancelado" CssClass="col-form-label col-9"/>
                        </div>   
                        <div class="row col-12">
                            <asp:Label runat="server" BorderStyle="none" class="col form-control col-12"><strong>Motivo por el que cancela mantenimiento: </strong></asp:Label>
                            <div class="col-md-12 align-self-center" style="margin-left: auto; margin-right: auto">
