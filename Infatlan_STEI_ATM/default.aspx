                    ...
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            <div>
                                ...
                                <p class="text-muted">ATM<br /><br /></p>
                            </div>
                            <div class="ml-auto">
                    ...
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            <div>
                                ...
                                <p class="text-muted">Preventivos<br />Realizados</p>
                            </div>
                            <div class="ml-auto">
                    ...
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            <div>
                                ...
                                <p class="text-muted">Preventicos<br />Asignados</p>
                            </div>
                            <div class="ml-auto">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            <div>
                                <h3><i class="ti-envelope"></i></h3>
                                <p class="text-muted">Correctivos<br />Realizados</p>
                            </div>
                            <div class="ml-auto">
                                <h2 runat="server" id="H1MantCorRealizados" class="counter text-cyan"></h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
                    ...
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center">
                            <div>
                                ...
                                <p class="text-muted">Correctivos<br />Asignados</p>
                            </div>
                            <div class="ml-auto">
                                <h2 runat="server" id="H1MantCorAsignados" class="counter text-purple"></h2>
                            </div>
                        </div>
                    </div>
                    <div class="col-12">
        ...
        <div class="col-md-12 align-self-center" style="margin-left: auto; margin-right: auto">
            <div class="table-responsive">
                <asp:GridView ID="GVMantenimiento" runat="server"
                    ...
                    <Columns>
                        <asp:BoundField DataField="ATM" HeaderText="ATM" ItemStyle-Width="20%" />
                        <asp:BoundField DataField="TECNICO" HeaderText="Responsable" ItemStyle-Width="20%" />
