        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><asp:Label ID="Label16" runat="server" /></li>
                </ol>
            </div>
        </div>
    </div>
                                                                                ...
                                                                                <Columns>
                                                                                    ...
                                                                                    <asp:TemplateField HeaderStyle-Width="60px" Visible="true">
                                                                                        ...
                                                                                        <div style="padding: 0 0 5px 0">
                                                                                            <asp:Label Text="Costo Total Materiales" runat="server" /></div>
                                                                                    </FooterTemplate>

                                                                                        <FooterTemplate>
                                                                                            <div>
                                                                                                <asp:Label ID="txtCostoTotalMateriales1" runat="server" />
                                                                                            </div>
                                                                                        </FooterTemplate>  
                                                                                        --%>
                                                                                    </asp:TemplateField>
                            ...
                            <div class="p-20">
                                <div class="row">
                                    ...
                                    <div class="col-12 grid-margin stretch-card">
                                        <div class="card">
                                            <h3 class="card-title">Costos Cotización </h3>

                                            <p>Calculos de los costos que genera un estudio.</p>
