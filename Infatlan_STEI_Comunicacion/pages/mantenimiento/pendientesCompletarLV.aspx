<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="pendientesCompletarLV.aspx.cs" Inherits="Infatlan_STEI_Comunicacion.pages.mantenimiento.pendientesCompletarLV" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Pendientes Completar LV</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <asp:UpdatePanel runat="server" ID="UpPendientesCompletarLV" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Mantenimientos Pendientes Completar LV</h4>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive m-t-20">
                            <asp:GridView ID="GvPendientesCompletarLV" runat="server"
                                CssClass="table table-bordered"
                                PagerStyle-CssClass="pgr"
                                HeaderStyle-CssClass="table"
                                RowStyle-CssClass="rows"
                                AutoGenerateColumns="false"
                                AllowPaging="true" OnPageIndexChanging="GvPendientesCompletarLV_PageIndexChanging"
                                GridLines="None" OnRowCommand="GvPendientesCompletarLV_RowCommand"
                                PageSize="10">
                                <Columns>
                                   <asp:BoundField DataField="idMantenimiento" HeaderText="Id" />
                                    ...
                                    <asp:BoundField DataField="fechaMantenimiento" HeaderText="Mantenimiento" ItemStyle-HorizontalAlign="Center"/>
                                    <asp:TemplateField HeaderText="Seleccione" HeaderStyle-Width="15%" ItemStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
