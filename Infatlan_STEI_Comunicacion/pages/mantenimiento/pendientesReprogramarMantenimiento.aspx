<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="pendientesReprogramarMantenimiento.aspx.cs" Inherits="Infatlan_STEI_Comunicacion.pages.mantenimiento.pendientesReprogramarMantenimiento" %>
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Mantenimientos Pendientes de Reprogramar</li>
                </ol>
            </div>
        </div>
    </div>

    <asp:UpdatePanel runat="server" ID="UpPendientesReprogramar" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Mantenimientos Pendientes Reprogramar</h4>
                    <h6 class="card-subtitle">Mantenimientos pendientes de reprogramar que estan asignadas a su persona.</h6>
                    <div class="card-body">
                        <div class="row col-7">
                            ...
                            <asp:GridView ID="GvPendientesReprogramar" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Seleccione" HeaderStyle-Width="10%" ItemStyle-HorizontalAlign="center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LbReprogramar" runat="server" class="btn btn-info mr-2" CommandName="Reprogramar" CommandArgument='<%# Eval("idMantenimiento") %>'>
