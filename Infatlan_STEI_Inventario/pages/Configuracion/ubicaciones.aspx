<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="ubicaciones.aspx.cs" Inherits="Infatlan_STEI_Inventario.pages.Configuracion.agencias" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-9">
                                            <asp:TextBox ID="TxCodigo" ReadOnly="true" class="form-control text-uppercase" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
