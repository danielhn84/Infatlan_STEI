                            ...
                            <asp:GridView ID="GVBusqueda" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Seleccione">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="BtnEditar" Visible="false" runat="server" class="btn btn-info mr-2" CommandArgument='<%# Eval("idMarca") %>' CommandName="EditarMarca">
                                                <i class="icon-pencil" ></i>
                                            </asp:LinkButton>
                            
                                            <asp:LinkButton ID="BtnBorrar" Visible="false" runat="server" class="btn btn-primary mr-2" CommandArgument='<%# Eval("idMarca") %>' CommandName="EliminarMarca">
