<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="newFecha.aspx.cs" Inherits="Infatlan_STEI_Agencias.pages.configuraciones.newFecha" %>
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">Agencia</a></li>
                                        ...
                                        <Columns>                                        
                                            ...
                                            <asp:BoundField DataField="Fecha" HeaderText="Fecha Mantenimiento" HtmlEncode=False DataFormatString="{0:dd/MM/yyyy}" ItemStyle-HorizontalAlign="center" />
                                             <asp:TemplateField HeaderText="Select" ItemStyle-HorizontalAlign="center">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="BtnSeleccionar" Visible="true" runat="server" class="btn btn-info ti-pencil-alt mr-2" Text="" CommandArgument='<%# Eval("ID") %>' CommandName="Select"></asp:LinkButton>
