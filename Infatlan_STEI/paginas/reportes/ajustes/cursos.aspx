<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="cursos.aspx.cs" Inherits="Infatlan_STEI.paginas.reportes.ajustes.cursos" %>
<asp:Content ID="Content1" ContentPlaceHolderID="Head" runat="server">
    ...
    <script type="text/javascript">
        function openModal() { $('#ModalCursos').modal('show'); }
        function cerrarModal() { $('#ModalCursos').modal('hide'); }
    </script>
</asp:Content>
        ...
        <ContentTemplate>
            <div class="card">
                <div class="card-body">
                    ...
                    <h6 class="card-subtitle">Métodos de evaluación para metas de cumplimiento.</h6>
                    <div class="card-body">
                        ...
                        <div class="table-responsive m-t-20">
                            <asp:GridView ID="GVBusqueda" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="BtnEditar" Visible="false" runat="server" class="btn btn-info" CommandArgument='<%# Eval("idCurso") %>' CommandName="EditarCurso">
