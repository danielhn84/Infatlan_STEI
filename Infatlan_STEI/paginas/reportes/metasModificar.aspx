<%@ Page Title="" Language="C#" MasterPageFile="~/main.Master" AutoEventWireup="true" CodeBehind="metasModificar.aspx.cs" Inherits="Infatlan_STEI.paginas.reportes.metasModificar" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="UpdatePanel">
        <ContentTemplate>
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Reportes a Modificar</h4>
                    <h6 class="card-subtitle">Reportes pendientes a modificar.</h6>
                        ...
                        <div class="table-responsive m-t-20">
                            <asp:GridView ID="GVBusqueda" runat="server"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:LinkButton ID="BtnEntar" runat="server" class="btn btn-primary" title="Aprobar" CommandArgument='<%# Eval("idReporte") %>' CommandName="verReporte">
